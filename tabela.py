...
for i in list_inoutControl:
    ...
    Data = informacoes['DATA'][iii]
    Fase = informacoes['FASE'][iii]
    Campeonato = informacoes['CAMPEONATO'][iii]
    ...
    try:
        ...
        df_full['posse_de_bola'] = round(df_full['Ar_Pts_T'] - df_full['RO'] + df_full['ER'] + (0.4 * df_full['LL_T']),
                                         0)
